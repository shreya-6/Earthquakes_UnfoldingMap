...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		triangle(40,105,47,95,55,105);
	
		fill(color(255, 255, 255));
		ellipse(48, 120, 14, 14);     //Land quake
		
		fill(color(255, 255, 255));
		rect(42,138,14,14);          // Ocean quake
		
		fill(color(255, 255, 0)); //Shallow --> yellow
		ellipse(48, 195, 14, 14);
		fill(color(0, 0, 255));  //Intermediate --> blue
		ellipse(48, 217, 14, 14);
		fill(color(255, 0, 0));   //Deep --> red
		ellipse(48, 239, 14, 14);
		
		fill(color(255, 255, 255));   //Past day
		ellipse(48, 261, 14, 14);
		line(40,253,55,270);
		line(55,253,40,270);
		
		fill(0, 0, 0);
		text("City Marker", 75, 100);
		text("Land Quake", 75, 122);
		text("Ocean Quake", 75, 144);
		text("Size  ~  Magnitude",40, 166);
		text("Shallow", 75, 195);
		text("Intermediate", 75, 217);
		text("Deep", 75, 239);
		text("Past Day", 75, 261);
	}
		       ...
		       for (Marker cm : countryMarkers) {
		    	   ...
		    	   for(Marker quake:quakeMarkers) {
		    		   if(quake instanceof LandQuakeMarker ) {
		    			   if(cm.getProperty("name").equals(quake.getProperty("country"))) {
		    				   countryQuakeCount++;
		    			   }	   
		    		   }
		    	   }
		    	   if(countryQuakeCount>=1) {
		    		   System.out.println(cm.getProperty("name") + " : " + countryQuakeCount);
		    	   }
		       }
		       System.out.println();
		    	   for(Marker quake:quakeMarkers) {
